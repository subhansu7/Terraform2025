...
#Below code is for creating key pair. Terraform to use my existing public key to create a new key pair in AWS.
#This key pair will be used to connect to the EC2 instance.cd
